        ...
        <div className="p-4 md:p-6 text-xs font-sans text-white h-full flex flex-col justify-between select-none">
          <div>
            ...
            <div className="space-y-3">
              <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">Project Timeline Stages</p>
              <div className="grid grid-cols-4 gap-1.5 text-center text-[9px]">
                ...
                <div className="bg-white/5 border border-white/5 text-slate-400 p-2 rounded-lg opacity-60">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4 border-t border-white/5 pt-3">
            <div className="bg-slate-900/50 p-2.5 rounded-xl border border-white/5">
              <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider mb-1">Recent Approvals</p>
            ...
            <div className="bg-slate-900/50 p-2.5 rounded-xl border border-white/5 flex flex-col justify-between">
              <div>
                <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider mb-1">Next Milestone</p>
            ...
            <div className="flex items-end justify-between gap-2 h-16 px-2">
              {[45, 60, 52, 75, 90].map((h, idx) => (
                <div key={idx} className="flex-1 flex flex-col items-center gap-1">
                  ...
                  <span className="text-[7px] text-slate-400">{idx + 8}:00</span>
                </div>
              ))}
            </div>
          </div>
      ...
      return (
        <div className="p-4 md:p-6 text-xs font-sans text-white h-full flex flex-col justify-between select-none">
          <div>
            ...
            {/* Cargo list */}
            <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider mb-2">Active Cargo & Shipments</p>
            <div className="space-y-2">
              <div className="bg-slate-900/50 border border-white/5 p-2 rounded-xl flex items-center justify-between">
                <div>
                  <p className="font-bold text-[10px] text-white">MV Sea Opal - VG30 Bitumen Import</p>
                  <p className="text-[8px] text-slate-400">Qty: 24,000 MT · Origin: USA-Iraq</p>
                </div>
              ...
              <div className="bg-slate-900/50 border border-white/5 p-2 rounded-xl flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[8px] text-slate-400">Qty: 180 Tons · Route: Local aggregator</p>
                </div>
          ...
          <div className="mt-4 pt-3 border-t border-white/5 grid grid-cols-3 gap-2">
            <div className="bg-background/40 p-2 rounded-lg border border-white/5 text-center">
              <span className="text-[8px] text-slate-400 block mb-0.5">SGS Quality</span>
            ...
            <div className="bg-background/40 p-2 rounded-lg border border-white/5 text-center">
              <span className="text-[8px] text-slate-400 block mb-0.5">Bill of Lading</span>
              <span className="text-[9px] font-bold text-eco flex items-center justify-center gap-0.5">
                <span className="w-1.5 h-1.5 bg-eco rounded-full inline-block" /> VERIFIED
              </span>
            </div>
            <div className="bg-background/40 p-2 rounded-lg border border-white/5 text-center">
              <span className="text-[8px] text-slate-400 block mb-0.5">LC Clearance</span>
              <span className="text-[9px] font-bold text-eco flex items-center justify-center gap-0.5">
        ...
        <div className="p-4 md:p-6 text-xs font-sans text-white h-full flex flex-col justify-between select-none">
          <div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-[8px] text-slate-400 font-bold uppercase tracking-wider pb-1 border-b border-white/5">
              ...
              <div className="flex justify-between text-[9px] items-center py-1">
                ...
                <span className="text-slate-400">₹41,800/MT</span>
              ...
              <div className="flex justify-between text-[9px] items-center py-1 border-t border-white/5">
                ...
                <span className="text-slate-400">₹40,900/MT</span>
              ...
              <div className="flex justify-between text-[9px] items-center py-1 border-t border-white/5">
                ...
                <span className="text-slate-400">₹42,500/MT</span>
          ...
          <div className="bg-[#121824] border border-eco/20 rounded-xl p-2.5 flex items-center justify-between text-[9px]">
            <div>
              ...
              <span className="text-slate-400">Bio-bitumen margins expanded by +₹800/MT this week due to rising crude.</span>
            </div>
      ...
      return (
        <div className="p-4 text-xs font-sans text-white h-full flex flex-col justify-center select-none">
          <div className="w-full max-w-[260px] mx-auto bg-[#07090E] border border-white/10 rounded-2xl p-3.5 shadow-inner flex flex-col justify-between aspect-[9/13]">
            <div>
              {/* Mobile Top Bar */}
              <div className="flex justify-between items-center text-[7px] text-slate-400/60 border-b border-white/5 pb-1 mb-2.5 font-mono">
              ...
              <div className="flex items-center gap-1.5 mb-3">
                ...
                <div>
                  ...
                  <p className="text-[6px] text-slate-400">Plant Supervisor · Punjab 01</p>
                </div>
              </div>

              {/* Shift Checklist */}
              <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider mb-2">Shift Checklist</p>
            ...
            <div className="mt-2 pt-2 border-t border-white/5 flex items-center justify-between">
              <span className="text-[6px] text-slate-400 font-mono">Unsent logs: 0</span>
          ...
          <button
            ...
            className={`
              ...
              ${i === activeIndex 
                ...
                : "bg-surface border-border text-secondary hover:text-primary hover:bg-background"}
              border
            `}
          >
            {i === activeIndex && (
                ...
                <div className="relative z-10 grid lg:grid-cols-12 gap-12 items-center">
                  ...
                  <div className="lg:col-span-6 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Example blockquote */}
                      {service.example && (
                        <div className="bg-background border border-border/80 rounded-xl p-5 mb-8 relative overflow-hidden group">
