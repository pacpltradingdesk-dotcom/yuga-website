...
export default function CredentialsBar() {
  return (
    <section className="bg-surface relative py-12 px-6 overflow-hidden border-y border-border">
      {/* Background Glow */}
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          {KEY_CREDENTIALS.map((cred, i) => (
            <motion.span
              ...
              key={cred}
              className="glass hover:glass-hover flex items-center gap-2 text-secondary hover:text-primary transition-colors text-xs md:text-sm font-semibold px-5 py-2.5 rounded-full cursor-default"
            >
