      ...
      <section className="bg-background relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl text-primary font-extrabold tracking-tight mb-6">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <motion.div 
              ...
              className="lg:col-span-4 relative rounded-3xl overflow-hidden border border-slate-800 hover:border-accent/40 shadow-2xl group min-h-[420px] flex flex-col justify-end p-8"
            >
              <div 
              ...
              <div className="relative z-20">
                ...
                <div className="grid grid-cols-2 gap-2 text-center text-xs font-semibold uppercase tracking-wider text-white">
                  <div className="bg-slate-900/60 border border-slate-800 px-3 py-2 rounded-lg backdrop-blur-md">
                    <p className="text-accent font-extrabold">20-25%</p>
                    <p className="text-slate-400 text-[9px] mt-0.5">Bio-Oil Yield</p>
                  </div>
                  <div className="bg-slate-900/60 border border-slate-800 px-3 py-2 rounded-lg backdrop-blur-md">
                    <p className="text-accent font-extrabold">450-550°C</p>
                    <p className="text-slate-400 text-[9px] mt-0.5">Heat Range</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            <Link
              href="/pyrolysis"
              className="inline-flex items-center gap-2 bg-white border border-border text-primary font-bold px-8 py-4 rounded-full hover:bg-surface-light transition-all text-sm uppercase tracking-wider group"
            >
